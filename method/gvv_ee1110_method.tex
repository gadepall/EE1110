...
\begin{abstract}
%\boldmath
This manual shows how  boolean logic and digital design can be introduced to beginners through a hands on approach.
\end{abstract}
\section{Requirements}
\begin{enumerate}
\item The course is of 1 credit and the hands on module should be completed in 15 hours.
...
\item The hands on sessions should span over 5 days, with a 3 hour session every day.
...
\item \cite{adld} introduces the  binary number system, truth tables, boolean logic and  sequential logic by designing a decade
counter.
\item \cite{kmap_fsm} explains Karnaugh maps and the finite state machine.  The Karnaugh map is explained through the truth tables in
\cite{adld} and the decade counter in \cite{adld} is used for introducing the state machine.
\end{enumerate}
\section{Tutorials and Exams}
\begin{enumerate}
...
\bibliography{IEEEabrv,gvv_ee1110_method}
